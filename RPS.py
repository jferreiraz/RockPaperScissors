...
def player(prev_opponent_play, opponent_history = []):
    global history_game, prev_play, opponent_list, ideal_response, opponent_quincy_counter, play_order
    opponent_history.append(prev_opponent_play)
    history_game.append(prev_play)
